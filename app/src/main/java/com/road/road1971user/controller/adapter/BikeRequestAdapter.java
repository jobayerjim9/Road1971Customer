...
public class BikeRequestAdapter extends RecyclerView.Adapter<BikeRequestAdapter.MyRequestViewHolder> {
    private Context context;
    private ArrayList<RentBikeData> rentTruckData;
    private String type;
    GoogleMap thisMap;

    public BikeRequestAdapter(Context context, ArrayList<RentBikeData> rentTruckData,String type) {
    ...
    public void onBindViewHolder(@NonNull MyRequestViewHolder holder, int position) {
        ...
        holder.viewDetailsRequest.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AppData.setRentBikeData(rentTruckData.get(position));
