...
public class TruckRequestAdapter extends RecyclerView.Adapter<TruckRequestAdapter.MyRequestViewHolder> {
    private Context context;
    private ArrayList<RentTruckData> rentTruckData;
    GoogleMap thisMap;
    public TruckRequestAdapter(Context context, ArrayList<RentTruckData> rentTruckData) {
    ...
    @Override
    public void onBindViewHolder(@NonNull MyRequestViewHolder holder, final int position) {
        LatLng source,des;
        ...
        if(thisMap != null) {
            ...
            thisMap.addMarker(new MarkerOptions()
                    .position(source)
                    .title(rentTruckData.get(position).getLoadLocation())
                    .icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_AZURE)));

            thisMap.addMarker(new MarkerOptions()
                    .position(des)
                    .title(rentTruckData.get(position).getUnloadLocation())
        ...
        holder.viewDetailsRequest.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                i.putExtra("type","Truck");
                AppData.setRentTruckData(rentTruckData.get(position));
