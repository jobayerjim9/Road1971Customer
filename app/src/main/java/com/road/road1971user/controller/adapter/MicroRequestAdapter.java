...
public class MicroRequestAdapter extends RecyclerView.Adapter<MicroRequestAdapter.MyRequestViewHolder> {
    private Context context;
    private ArrayList<RentMicroData> rentTruckData;
    GoogleMap thisMap;
    public MicroRequestAdapter(Context context, ArrayList<RentMicroData> rentTruckData) {
    ...
    public void onBindViewHolder(@NonNull MyRequestViewHolder holder, int position) {
        ...
        holder.viewDetailsRequest.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                i.putExtra("type","Micro");
                AppData.setRentMicroData(rentTruckData.get(position));
